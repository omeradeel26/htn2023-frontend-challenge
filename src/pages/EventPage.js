      ...
      <Center minHeight={"90vh"}>
        ...
        >
          ...
          <Flex>
            ...
            <Box w="75%">
              <Text marginBottom="7px" variant="eventSubPage">
                Description
              </Text>
              ...
              <Flex>
                {event.speakers.length != 0 && (
                  <Box w="40%">
                    <Text variant="eventSubPage" marginTop="8px" marginBottom="7px">
                      Speakers
                    </Text>
                ...
                <Box w="60%">
                  {event.related_events.length > 0 && 
                    <Text variant="eventSubPage" marginTop="8px" marginBottom="7px">Related Events</Text>
                  }
                  {renderRelatedEvents()}
                </Box>
              </Flex>
